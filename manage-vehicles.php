					...
					<div class="panel-body">
						...
						<div class="col-md-12">
							...
							<form method="POST">
								...
								<div class="form-group">
									<label>Vehicle's Cost </label>
									<!-- <input type="text" class="form-control" placeholder="1Hr To 50 Rupay" id="vehcomp" name="vehcomp" required> -->
					
									<select class="form-control" name="catename" id="catename">

										<option value="volvo">1Hr To 50 ₹ Rupay</option>
										<option value="saab">2Hr To 100 ₹ Rupay</option>
										<option value="opel">12Hr To 500 ₹ Rupay</option>
										<option value="audi">24Hr To 950 ₹ Rupay</option>
										</select>
