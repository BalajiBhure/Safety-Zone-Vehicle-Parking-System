<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				<div class="profile-usertitle-name">Balaji</div>
		...
		<ul class="nav menu">
			...
			<li class="<?php if($page=="vehicle-parkinglot") {echo "active";}?>"><a href="parkinglot.php"><em class="fa fa-info">&nbsp;</em> Vehicle Parking Lot</a></li>
			<li class="<?php if($page=="manage-vehicles") {echo "active";}?>"><a href="manage-vehicles.php"><i class="fa fa-car">&nbsp;</i> Vehicle Entry</a></li>
